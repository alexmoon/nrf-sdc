...
//!
//! This crate provides a high-level async API for the Nordic SoftDevice Controller, which is a closed-source
...
/// Re-export of the `nrf-mpsl` and `nrf-sdc-sys` crates.
